// Command device-api is the Lambda entry point for the Lambda-authorized
// device routes (docs/05-backend.md §1.1): /device/uploads, /device/logout.
//
...
// (infra/envs/dev/main.tf's device_routes).
package main
